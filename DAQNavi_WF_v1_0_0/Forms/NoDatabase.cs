...
namespace DAQNavi_WF_v1_0_0.Forms
{
    public partial class NoDatabase : MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            config.AppSettings.Settings["defaultDatabaseAddress"].Value = NoDb_textBox_baza.Text;
            config.AppSettings.Settings["defaultPort"].Value = NoDb_textBox_port.Text;
            config.AppSettings.Settings["defaultDatabaseUser"].Value = NoDb_textBox_login.Text;
            config.AppSettings.Settings["defaultDatabasePassword"].Value = NoDb_textBox_haslo.Text;
            config.AppSettings.Settings["defaultDatabaseName"].Value = NoDb_textBox_nazwa.Text;
